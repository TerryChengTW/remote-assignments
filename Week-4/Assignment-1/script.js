...
delayedResult(4, 5, 3000, function (result1) {
    console.log(result1)
    // console.log("callback: " + result1);
}); // 9 (4+5) will be shown in the console after 3 seconds
delayedResult(-5, 10, 2000, function (result2) { 
    console.log(result2)
    // console.log("callback: " + result2);
...
async function main() {
        ...
        result2 = await delayedResultPromise(-5, 10, 5000);
        console.log(result1)
        console.log(result2)
